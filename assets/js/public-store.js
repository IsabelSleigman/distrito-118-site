(() => {
  ...
  window.setupSupabaseOrderForm = async function() {
    ...
    const type=document.getElementById("customerType"), orgField=document.getElementById("organizationField"), items=document.getElementById("orderItems"), addButton=document.getElementById("addOrderItem"), totalEl=document.getElementById("orderTotal"), summaryEl=document.getElementById("orderSummary");
